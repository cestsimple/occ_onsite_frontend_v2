      ...
      activities: [
        ...
        },
        {
          content: ['设置每日1:55,4:25服务器自动重启;',
            '\n增加手动停止record相关job接口,抓取数据前会清空所有已存在任务;'],
          timestamp: '2022-6-6'
        },
        {
          content: ['新增非OCC人员搜索功能限制,只能查看自己区域的内容;',
            '\n新增月报变量修改功能'],
          timestamp: '2022-6-2'
        },
        {
          content: ['修改月报变量页面功能展示;',
            '\n增加月报变量功能聚合功能;',
            '\n修复使用权限过滤功能后刷新导致页面404的问题'],
          timestamp: '2022-6-1'
        },
        {
          content: ['修复asset登记页面绑定资产回显为数字ID的问题;',
            '\n修复DFT停机时用液计算错误的问题;',
            '\n新增角色页面编辑限制;',
            '\n新增角色路由权限功能,会根据登陆用户的角色显示对应左边导航栏;'],
          timestamp: '2022-5-31'
        },
        {
        ...
        },
        {
          content: ['新增IOT刷新时间选择;',
            '\n调整页面布局及路由匹配;',
            '\n调整维修表关联隐藏;',
            '\n修复filling添加完不刷新页面的问题,修复月报变量登记不为英文的问题;'],
          timestamp: '2022-5-26'
        },
        {
          content: ['完成用户页面角色显示;',
            '\n修改malfunction提交原因为英文,表格调整;',
            '\n修改时间筛选至日期,新增malfunction原因过滤;',
            '\n新增用户角色页面及功能;',
            '\n完成权限管理页面,角色权限页面的功能;',
            '\n完成角色权限的增删改查功能,用户角色的相关表的关联删除;'],
          timestamp: '2022-5-25'
        },
        {
          content: ['新增用户角色api;',
            '\n新增停机confirm处理;',
            '\n修复filling更新lintot时根据site查找会找到多台apsa的问题;',
            '\n新增用户角色页面及功能;',
            '\n修改停机页面布局,标准化停机原因,修改所有弹层不可鼠标点击空白取消;',
            '\n修改searchbar默认HHmm设定,调整daily页面样式;',
            '\n修改malfunction页面表单验证规则;'],
          timestamp: '2022-5-24'
        },
        {
          content: ['增加record刷新多线程监控;',
            '\n调整Task执行逻辑和时间;'],
          timestamp: '2022-5-23'
        },
        {
          content: ['修复月报数据生成时间限制错误;',
            '\n修复因-0.05等微小负值导致无法计算lintot的问题;',
            '\n调整弹层为固定宽度;'],
          timestamp: '2022-5-21'
        },
        {
        ...
        },
        {
          content: ['修复malfunction信息登记功能若干bug,修复逻辑错误;',
            ...
            '\n修复daily,filling报表点击修改无法正确加载数据的问题;',
            '\n修改daily报表导出内容及顺序'],
          timestamp: '2022-5-19'
        },
        {
          content: ['新增日报，停机报表导出功能;\n新增设备管理表asset name字段以作区分;',
            '\n新增设备管理表可以隐藏不计入报表的资产;',
            '\n修复apsa设备登记相关bug(特殊计算绑定自己，常规计算有绑定值);'],
          timestamp: '2022-5-18'
        },
        {
